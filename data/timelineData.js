const timelineData = [
  ...
  },
  {
    ...
    role: 'Front End Developer Chapter Lead',
    company: 'Logickit',
    companyURL: 'https://logickit.io',
    works: [
  ...
  },
  {
    ...
    company: 'Bimebazar',
    companyURL: 'https://bimebazar.ir/',
    companyBio: '(Insurance)',
    description:
    ...
    works: [
      ...
      'Design & develop beautiful, easy-to-use web applications and sites that support Bimebazar marketing campaigns.',
    ],
  },
  {
    time: 'Jan 2013 - Aug 2013',
    role: 'Front-end Developer and UI Designer',
    company: 'Karina Mobile Solution',
    companyURL: 'https://karinaco.ir/',
    works: [
